...
#if KGOLD
    //logo
    logoBtn.frame =  CGRectMake(7, 2, 120, 40);
  //  logoBtn.backgroundColor = [UIColor yellowColor];
    ...
    if(imgStr.length > 0)
    {
       ...
       // [logoBtn setImage:[UIImage imageNamed:@"town_logo"] forState:UIControlStateNormal];
    }
    else
    {
#if KGOLD
