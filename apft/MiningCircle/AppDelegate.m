...
-(void)share
{
    ...
    NSString *shareKey = @"1aec2843d5df8";
    NSString *wcId = @"wxfecc234ff4f21ee7";
    NSString *wcSecret = @"03d06b4e54c4bb0c8601afffe2ec80d3";
    NSString *qqId = @"1105959006";
    NSString *qqKey = @"fEAZBZsUvpbc9XHP";
    NSString *wbKey = @"2809405453";
    NSString *wbSecret = @"d8c252a7737375a09c92930fcecaab11";
