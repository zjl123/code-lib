...
- (void)viewDidLoad {
   ...
   // [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor whiteColor]}]
    self.settingnames =@[@[ZGS(@"alertPhoto")],@[ZGS(@"logPwd"),ZGS(@"fundPwd"),ZGS(@"gesture")],@[ZGS(@"feedback"),ZGS(@"clearCach")]];
    imageArr = @[@[@"headImageEdit"],@[@"login_psw",@"money_psw",@"lck"],@[@"suggest",@"clear"]];
