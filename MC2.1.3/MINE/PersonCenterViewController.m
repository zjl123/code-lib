...
#if KMIN
    [nv.navigationBar setBarTintColor:BLUECOLOR];
#elif KGOLD
...
-(void)setUpKuangYeYi
{
   ...
   // NSLog(@"PCCCPCCC");
    ...
    collView  = [[UICollectionView alloc]initWithFrame:CGRectMake(0, 0, width1, height1-self.tabBarController.tabBar.frame.size.height-TABANOHEIGHT+12) collectionViewLayout:flowLayout];
...
#if KGOLD
    //logo
    logoBtn.frame =  CGRectMake(7,20+2, 88, 40);
