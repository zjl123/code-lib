...
- (void)initView {
    ...
    self.ratioView.layer.borderColor = RGB(36, 157, 238).CGColor;
...
- (void)initControlBtn {
   ...
   // cancelBtn.backgroundColor = [UIColor blackColor];
    ...
    [cancelBtn setTitle:ZGS(@"cancle") forState:UIControlStateNormal];
    ...
    [confirmBtn setTitle:ZGS(@"ok") forState:UIControlStateNormal];
