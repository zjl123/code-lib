...
- (void)initCircles
{
   ...
   //     int x = kCircleMargin + (i%3) * (kCircleDiameter+(width1-kCircleMargin*2- kCircleDiameter *3)/2);
      //  int x = width1/4*(i%3+1)+kCircleDiameter*(i%3);
        int x = (width1-3*kCircleDiameter)/4*(i%3+1)+kCircleDiameter*(i%3);
        int y = kCircleMargin + (i/3) * (kCircleDiameter+(width1-kCircleMargin*2- kCircleDiameter *3)/2);
