...
- (void)viewDidLoad {
    ...
    //标题view
//    titleView = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, width1, 40)];
//    titleView.backgroundColor = RGB(245, 245, 245);
//    titleView.lineBreakMode = NSLineBreakByTruncatingTail;
//    titleView.textColor = RGB(51, 51, 51);
//    titleView.textAlignment = NSTextAlignmentCenter;
//    titleView.text = @"XXXXXX";
//    [web.scrollView addSubview:titleView];
//    webBrowserView = web.scrollView.subviews[0];
//    CGRect frame = webBrowserView.frame;
//    frame.origin.y = CGRectGetMaxY(titleView.frame);
