...
{
    [self.classfiyDelegate ClassfiyClick:indexPath.section andRow:indexPath.row andTag:@""];
}
...
-(UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *str = [NSString stringWithFormat:@"推荐商品%d",indexPath.section];
...
-(void)btnCLick:(UIButton *)sender
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [self.classfiyDelegate ClassfiyClick:index.section andRow:index.row andTag:sender.titleLabel.text];
    });
